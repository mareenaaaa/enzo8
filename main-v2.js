...
const portfolioCaseStudies = {
    ...
    "french-avenue-safari": {
        ...
        paragraphs: [
            ...
            `Safari Breeze is a fragrance defined by contrast - warmth and freshness, intensity and freedom. To visualise the fragrance profile, we introduced a dynamic collision of elements: cascading orange citrus, vibrant green botanicals, and deep red berries. These components interact through fluid simulations, building momentum before converging to form the bottle itself.`,
    ...
    "cultfit-massager-02": {
        ...
        paragraphs: [
            `To introduce the Cult Gun Massager, the brief went beyond product demonstration - it asked for a visceral expression of relief. The creative idea centered on transforming muscle stiffness into a tangible antagonist: a mechanical, stone-like human form embodying extreme tension and pain. Enso 8 developed a custom procedural fracturing setup to simulate stone armor breaking on contact.`,
    ...
    "adidas-cultfit": {
        brand: "Adidas x Cult.fit",
        title: "Adidas x Cult.fit: Adidas Strength+ Campaign",
    ...
    "protein-chef": {
        ...
        paragraphs: [
            ...
            `We designed a league of "Bread Superheroes," each visually expressing its nutritional benefit. From the spear-wielding Brown Bread to the haloed Multigrain hero, every character carried unique silhouettes, props, and attitudes - making health benefits instantly legible and memorable.`,
