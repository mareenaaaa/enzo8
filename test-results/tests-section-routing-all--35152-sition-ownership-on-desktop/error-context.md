...
- Name: tests/section-routing.spec.js >> all directed section pairs preserve transition ownership on desktop
- Location: tests/section-routing.spec.js:434:1

# Error details

```
Error: Contact did not scale down for contact -> services
